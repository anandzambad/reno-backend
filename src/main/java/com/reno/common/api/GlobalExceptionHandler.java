...
public class GlobalExceptionHandler {
    ...
    public ApiResponse<ErrorBody> business(IllegalArgumentException ex) {
        return new ApiResponse<>(false, new ErrorBody("RESOURCE_ERROR", ex.getMessage(), List.of()), ex.getMessage());
    }
