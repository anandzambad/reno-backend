...
public class BookingController {
 ...
 public record CreateRequest(@NotNull @Positive Long customerId,@NotNull @Positive Long contractorId,@NotNull @Positive Long serviceId,@DecimalMin("-90") @DecimalMax("90") double latitude,@DecimalMin("-180") @DecimalMax("180") double longitude,@Size(max=500) String address,Instant scheduledAt,@DecimalMin("0.0") @DecimalMax("1000000.0") BigDecimal estimatedPrice){}
